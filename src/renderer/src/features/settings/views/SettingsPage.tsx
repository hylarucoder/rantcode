...
import SingleClaudeVendor from '../components/SingleClaudeVendor'
import { useAgentsInfoQuery } from '../api/agentsHooks'
...
export default function SettingsPage() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden bg-gradient-to-br from-background via-background to-muted/20">
      {/* Titlebar drag area */}
      <div className="titlebar h-10 w-full shrink-0" />
